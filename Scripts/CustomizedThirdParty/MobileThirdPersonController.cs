...
#endif
    public class MobileThirdPersonController : GravityDelegator
    {
        [Header("Player")]
        ...
        public GameObject WaterInSplash;
        public GameObject WaterOutSplash;
        ...
        private void GroundedCheck()
        {
            ...
            if (OnWater)
            {
                ...
                {
                    Instantiate(WaterInSplash, new Vector3(transform.position.x, -WaterOffset, transform.position.z), Quaternion.identity);
                }
            }
            else
            {
                ...
                if (prevOnWater == true)
                {
                    Instantiate(WaterOutSplash, new Vector3(transform.position.x, -WaterOffset, transform.position.z), Quaternion.identity);
                }
